...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(MemVal.indexOf('rollover')!=-1){
		...
		this.rid=WhatMenu+'i';
		MemVal="<img src=newcdsoa//%22%22%2Bthis.ri1%2B%22/%22 name=\""+this.rid+"\" width=\""+Wdth+"\" height=\""+Hght+"\">"}
	this.value=MemVal;
	if(RcrsLvl==1){
		a=LowBgColor;
		b=HighBgColor;
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		if(DomYes){
			...
			t.style.top=T+P_X;
			t.style.left=L+P_X}
		else{	MemVal+="<div style='position:absolute; top:"+T+"; left:"+L+"; width:"+W+"; height:"+H+";visibility:inherit'><img src='newcdsoa/%22%2BS%2B%22'></div>";
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(this.value.indexOf('rollover')!=-1){
		...
		this.rid=WhatMenu+'i';this.value="<img src='newcdsoa/%22%2Bthis.ri1%2B%22' name='"+this.rid+"'>"}
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		ImgStr="<img src='newcdsoa/%22%2BArrws%5Ba%5D%2B%22' width='"+Arrws[a+1]+"' height='"+Arrws[a+2]+"'>";
