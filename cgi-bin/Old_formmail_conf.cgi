...
BEGIN
{
  ...
  @referers          = qw(capedory.org toolworks.com localhost);
  @allow_mail_to     = qw(c_m_monaghan@comcast.net capedorystuff@aol.com cthunberg@nobisengineering.com mabato@maine.rr.com dabramso@maine.rr.com setsail728@yahoo.com dwbradbury@hotmail.com carroll@metrocast.net localhost);
  @recipients        = ();
  %recipient_alias   = ();
