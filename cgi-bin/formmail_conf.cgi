...
BEGIN
{
  ...
  $postmaster        = 'c_m_monaghan@comcast.net';
  @referers          = qw(capedory.org toolworks.com);
  @allow_mail_to     = qw(c_m_monaghan@comcast.net capedorystuff@aol.com cthunberg@comcast.net melissa@sailmahalo.com dabramson@mainephoto.com setsail728@yahoo.com dwbradbury@hotmail.com cabradbury@lycos.com carroll@metrocast.net hbernabo@verizon.net neil@nrgordon.com);
  @recipients        = ();
  %recipient_alias   = ();
